...
-   `NEXT_PUBLIC_NEXTJS_SERVER_URL`: this is the URL at which the NextJS app is running, e.g. `https://<site>.azurewebsites.net`. Defaults to `http://localhost:3000` in development. Do not include a trailing slash when specifying this URL.
