    ...
    if (language === "ar") {
        return (
            <>
                <div dir="rtl">
                    <p>
                        مساعد الذكاء الاصطناعي من الجزيرة ("لبيب") هو الآن في
                        النسخة التجريبية. نريد أن يستمتع الناس باستخدامه واختبار
                        وظيفته، لكن يرجى توقع بعض عدم الاستقرار والبطء، خصوصاً
                        حول ميزات النموذج الأحدث التي غالبًا ما تكون في مرحلة ما
                        قبل الإصدار.
                    </p>
