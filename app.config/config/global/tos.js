    ...
    if (language === "ar") {
        return (
            <>
                <div dir="rtl">
                    <p>
                        نائب الجزيرة الذكاء الاصطناعي ("لبيب") الآن في بيتا. نريد الناس أن يستمتعوا 
                        باستخدامه واختبار الوظائف ، ولكن يرجى توقع بعض عدم الاستقرار والبطء ،
                        خاصة حول ميزات GPT-4 ، التي هي في مرحلة ما قبل الإصدار.
                    </p>

                    <p>
                        لضمان الاستخدام المسؤول و الأخلاقي للبيب ، يوافق المستخدم على الشروط والأحكام التالية:
                    </p>

                    <ul className="mb-3 list-disc ps-4">
                        <li>
                            يوافق المستخدم على عدم مشاركة نتائج أي تفاعلات مع لبيب علنيًا ، حيث قد يتسبب
                            ذلك في إلحاق الضرر. يشمل ذلك استخدام أية ترجمة ، ملخصات ،
                            تكوينات نصية ، أو رمز في إنشاء المحتوى أو المنتجات للجزيرة
                            دون التحقق بعناية من أن الناتج يتوافق مع معايير الجزيرة ذات الصلة.
                        </li>

                        <li>
                            على الرغم من أننا حاولنا ضبطلبيب ليكون دقيقًا ومسؤولًا ، يرجى ملاحظة
                            أن استخدام الذكاء الاصطناعي في القيام بالترجمة يمكن أن يؤدي أحيانًا إلى
                            نتائج غير متوقعة. يرجى مراجعة الترجمة بعناية للتأكد من صحتها ،
                            خاصة بالنسبة للحقائق مثل أسماء الأشخاص والأماكن والمدن
                            والبلدان والكيانات الأخرى.
                        </li>

                        <li>
                            قد تحتوي نتائج لبيب على أخطاء ، وعدم دقة ، ومحتوى مسيء ،
                            أو مشكلات أخرى قد تسبب الضرر. يوافق المستخدم على استخدام لبيب على مسؤوليته الخاصة.
                        </li>

                        <li>
                            أي شيء تدخله في لبيب ليس مضمونًا أن يكون خاصًا. يوافق المستخدم على أن أي معلومات يدخلها
                            في لبيب قد يتم تخزينها واستخدامها من قبل الجزيرة لأي غرض ، بما في ذلك
                            ولكن لا تقتصر على تحسين أداء لبيب ودقته ، ولأي غرض آخر يراه الجزيرة 
                            مناسبًا.
                        </li>
                    </ul>

                    <p>
                        إذا كان لديك أي أسئلة أو مخاوف حول استخدام لبيب ، 
                        يرجى الاتصال بفريق أرخبيل. يمكنك العثور علينا على 
                        سلاك أو إرسال بريد إلكتروني إلى dis@aljazeera.net.
                    </p>
                </div>
            </>
        );
