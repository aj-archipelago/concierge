                ...
                <Dialog as="div" className="relative z-50" onClose={() => {}}>
                    ...
                    <div className="fixed inset-0 overflow-hidden">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-6xl max-h-[calc(100vh-100px)] overflow-hidden transform rounded-md bg-white p-6 text-start align-middle shadow-xl dark:bg-gray-100 border dark:border-300 transition-all flex flex-col gap-3">
                                    <Dialog.Title
                                        as="h3"
