...
export async function serveWorkspaceFile(filePath) {
    ...
    if (!lookupRes.ok) {
        ...
        try {
            ...
            errMsg = parsed.body ?? parsed.error ?? parsed.message ?? errMsg;
        } catch {
    ...
    const contentType =
        contentRes.headers.get("content-type") || "text/html; charset=utf-8";
